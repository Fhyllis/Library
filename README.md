...
第一步：运行 sql 文件夹下的`springboot-vue.sql`，创建`springboot-vue`数据库(MySQL/H2)

第二步：IDEA运行后端SpringBoot项目,VScode运行前端Vue
...
SpringBoot、Mybatis-Plus、MySQL/H2、Vue3、ElementPlus等
